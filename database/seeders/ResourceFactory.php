...
class ResourceFactory extends Factory
{
    ...
    public function expensive(): static
    {
        return $this->state(fn (array $attributes) => [
            'cost_per_unit' => $this->faker->randomFloat(2, 100.00, 500.00),
            'type' => 'Processor',
        ]);
    }

    /**
     * Indicate that the resource has a long lead time.
     */
    public function longLeadTime(): static
    {
        return $this->state(fn (array $attributes) => [
            'lead_time_days' => $this->faker->numberBetween(30, 90),
        ]);
    }
}
