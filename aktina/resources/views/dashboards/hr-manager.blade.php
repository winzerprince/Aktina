<x-layouts.dashboard>
    <div class="space-y-6">
        <div class="flex items-center justify-between">
            <div>
                <flux:heading size="lg">HR Manager Dashboard</flux:heading>
                <flux:text class="mt-1 text-zinc-600 dark:text-zinc-400">
                    Welcome, {{ auth()->user()->name }}! Manage workforce and distribution here.
                </flux:text>
            </div>
            <flux:badge color="purple" variant="solid">
        ...
        <div class="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 rounded-lg p-6">
            <flux:heading size="lg" class="mb-4">HR Dashboard Tabs (Coming Soon)</flux:heading>
            <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                ...
                <div class="p-4 bg-zinc-50 dark:bg-zinc-800 rounded-lg text-center">
                    <flux:icon name="users" class="h-8 w-8 mx-auto mb-2 text-green-500" />
                    <flux:text class="font-medium">Tab 1: Workforce</flux:text>
                </div>
                <div class="p-4 bg-zinc-50 dark:bg-zinc-800 rounded-lg text-center">
                    <flux:icon name="truck" class="h-8 w-8 mx-auto mb-2 text-purple-500" />
                    <flux:text class="font-medium">Tab 2: Distribution</flux:text>
                </div>
                <div class="p-4 bg-zinc-50 dark:bg-zinc-800 rounded-lg text-center">
