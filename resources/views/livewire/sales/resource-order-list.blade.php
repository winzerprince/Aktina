    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <div class="bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl shadow-lg p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-blue-100 text-sm font-medium">Total Resource Orders</p>
            ...
            @forelse ($resourceOrders as $resourceOrder)
                <tr class="hover:bg-gray-50 transition-colors duration-200">
                    <td class="px-6 py-4 whitespace-nowrap">
                        <a href="{{ route('resource-orders.show', $resourceOrder->id) }}" class="font-medium text-blue-600 hover:text-blue-800 hover:underline">
                            #{{ $resourceOrder->id }}
                        </a>
                    </td>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div class="flex gap-2">
                            @if ($resourceOrder->status === 'pending')
                                <button wire:click="accept({{ $resourceOrder->id }})" wire:loading.attr="disabled"
                            ...
                            @if ($resourceOrder->status === 'accepted')
                                <button wire:click="complete({{ $resourceOrder->id }})" wire:loading.attr="disabled"
                ...
                <tr>
                    <td colspan="7" class="px-6 py-12 text-center">
                        <div class="flex flex-col items-center justify-center space-y-3">
                            ...
                            <div>
                                <p class="text-gray-500 text-lg font-medium">No resource orders found</p>
