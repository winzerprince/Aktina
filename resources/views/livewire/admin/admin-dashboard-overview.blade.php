<div class="space-y-6"
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700 p-6">
            ...
            <div id="order-trends-chart" class="h-80" wire:ignore></div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700 p-6">
            ...
            <div id="user-growth-chart" class="h-80" wire:ignore></div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700 p-6">
            ...
            <div id="revenue-chart" class="h-80" wire:ignore></div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700 p-6">
            ...
            <div id="role-distribution-chart" class="h-80" wire:ignore></div>
        </div>
    </div>
    ...
    <script>
        document.addEventListener('livewire:init', () => {
            ...
            function initAdminCharts() {
                ...
                // Order Trends Chart
                const orderTrendsElement = document.querySelector("#order-trends-chart");
                if (orderTrendsElement) {
                    ...
                    charts.orderTrends = new ApexCharts(orderTrendsElement, orderTrendsOptions);
                    charts.orderTrends.render();
                }

                // User Growth Chart
                const userGrowthElement = document.querySelector("#user-growth-chart");
                if (userGrowthElement) {
                    ...
                    charts.userGrowth = new ApexCharts(userGrowthElement, userGrowthOptions);
                ...
                if (revenueElement) {
                    ...
                    charts.revenue = new ApexCharts(revenueElement, revenueOptions);
                    charts.revenue.render();
                }

                // Role Distribution Chart
                const roleElement = document.querySelector("#role-distribution-chart");
                if (roleElement) {
                    ...
                    charts.roleDistribution = new ApexCharts(roleElement, roleOptions);
                    charts.roleDistribution.render();
                }
            }
            ...
            // Handle chart updates when Livewire data changes
