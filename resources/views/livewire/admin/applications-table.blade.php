<div class="space-y-4 lg:space-y-6">
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Vendor Applications</h1>
            <p class="text-gray-600 dark:text-gray-400">Manage and review vendor applications</p>
        </div>
    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
            <div>
                ...
                <input type="text" id="search" wire:model.live="search"
                       ...
                       placeholder="Search by reference, vendor name, or email">
            </div>
            ...
            <div class="flex items-end">
                <button wire:click="$refresh"
                        class="w-full lg:w-auto px-4 py-2 bg-gray-100 dark:bg-gray-600 text-gray-700 dark:text-gray-300 rounded-md hover:bg-gray-200 dark:hover:bg-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-500">
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead class="bg-gray-50 dark:bg-gray-700">
                    <tr>
                        <th wire:click="sortBy('application_reference')"
                            class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-600">
                            <div class="flex items-center space-x-1">
                                <span>Reference</span>
                                @if($sortField === 'application_reference')
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <div class="text-sm text-gray-500 dark:text-gray-400">
                                    {{ $application->vendor?->user?->email ?? 'N/A' }}
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-12 text-center">
                                <div class="text-gray-500 dark:text-gray-400">
                                    ...
                                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">No vendor applications match your current filters.</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
